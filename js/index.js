                            ...
                            <div class="card-body">
                                ...
                                <div class="lugar row w-100 m-auto  d-flex justify-content-center col text-center">
                                    ...
                                    <div class="col text-center">
                                        <button type="button" class="btn btn-warning btn-lg m-4" data-bs-toggle="modal" data-bs-target="#comprar" onclick="addToCart(${entradas[i].id});">Agregar al Carrito</button>
                                    </div>
                                </div>
                            </div>
                        </div>
